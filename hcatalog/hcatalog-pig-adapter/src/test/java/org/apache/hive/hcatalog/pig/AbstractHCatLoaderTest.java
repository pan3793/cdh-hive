...
public abstract class AbstractHCatLoaderTest extends HCatBaseTest {
  ...
  static void createTableDefaultDB(String tablename, String schema, String partitionedBy, IDriver
          driver, String storageFormat) throws IOException, CommandNeedRetryException {
    createTable(null, tablename, schema, partitionedBy, driver, storageFormat);
  }
  ...
  private void createTable(String db, String tablename, String schema) throws IOException, CommandNeedRetryException {
    createTable(db, tablename, schema, null);
  }

  private void createTableDefaultDB(String tablename, String schema) throws IOException, CommandNeedRetryException {
