...
public class TestSparkStatistics {
  ...
  @Test
  public void testSparkStatistics() throws MalformedURLException, CommandNeedRetryException {
    ...
    try {
      driver = new Driver(new QueryState.Builder().withHiveConf(conf).build(), null, null);
      ...
      Assert.assertEquals(25, sparkStats.size());
