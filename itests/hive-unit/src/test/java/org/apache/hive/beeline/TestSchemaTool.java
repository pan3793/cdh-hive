...
public class TestSchemaTool extends TestCase {
  ...
  public void testValidateSequences() throws Exception {
    ...
    String[] scripts = new String[] {
        ...
        "insert into DBS values(99, 'test db1', 'hdfs:///tmp', 'db1', 'test', 'test', 0)",
        "!closeall"
    };
    ...
    scripts = new String[] {
        ...
        "delete from DBS",
        "insert into SEQUENCE_TABLE values('org.apache.hadoop.hive.metastore.model.MDatabase', 100)",
        "insert into DBS values(102, 'test db1', 'hdfs:///tmp', 'db1', 'test', 'test', 0)",
        "!closeall"
    };
 ...
 // Test valid case
    String[] scripts = new String[] {
         "insert into DBS values(2, 'my db', 'hdfs://myhost.com:8020/user/hive/warehouse/mydb', 'mydb', 'public', 'role', 0)",
         "insert into DBS values(7, 'db with bad port', 'hdfs://myhost.com:8020/', 'haDB', 'public', 'role', 0)",
    ...
    scripts = new String[] {
        ...
        "delete from SDS",
        "delete from DBS",
        "insert into DBS values(2, 'my db', '/user/hive/warehouse/mydb', 'mydb', 'public', 'role', 0)",
        "insert into DBS values(4, 'my db2', 'hdfs://myhost.com:8020', '', 'public', 'role', 0)",
        "insert into DBS values(6, 'db with bad port', 'hdfs://myhost.com:8020:', 'zDB', 'public', 'role', 0)",
        "insert into DBS values(7, 'db with bad port', 'hdfs://mynameservice.com/', 'haDB', 'public', 'role', 0)",
