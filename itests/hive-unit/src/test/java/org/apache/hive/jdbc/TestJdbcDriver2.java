...
public class TestJdbcDriver2 {
  ...
  public void testShowTablesInDb() throws SQLException {
    ...
    stmt.execute("drop table if exists testDb." + tableNameInDbUnique);
    stmt.execute("create table testDb." + tableNameInDbUnique
        + " (under_col int comment 'the under column', value string) comment '" + tableComment
        + "'");

    ResultSet res = stmt.executeQuery("show tables in testDb");
  ...
  public void testInvalidShowTables() throws SQLException {
    ...
    ResultSet res = stmt.executeQuery("show tables " + "testDb");
    assertFalse(res.next());
    stmt.close();
  }
