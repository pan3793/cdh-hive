...
public final class QTestArguments {
  ...
  private boolean useHBaseMetastore;
  ...
  public boolean isWithHBaseMetastore() {
    return useHBaseMetastore;
  }

  private void setWithHBaseMetastore(boolean useHBaseMetastore) {
  ...
  public static final class QTestArgumentsBuilder {
    ...
    public QTestArgumentsBuilder withHBaseMetastore(boolean useHBaseMetastore) {
      this.useHBaseMetastore = useHBaseMetastore;
      return this;
    }
    ...
    public QTestArguments build() {
      ...
      testArguments.setWithHBaseMetastore(useHBaseMetastore);
