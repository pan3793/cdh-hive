...
-- -------------------------------------------------------------------------------------------------------------------------------------------------
-- Record schema version. Should be the last step in the init script. Starting CDH-5.12.1 CDH version also needs to be recorded in the version table
-- -------------------------------------------------------------------------------------------------------------------------------------------------
INSERT INTO "APP"."VERSION" (VER_ID, SCHEMA_VERSION, SCHEMA_VERSION_V2, VERSION_COMMENT) VALUES (1, '1.1.0', '1.1.0-cdh5.12.1', 'Hive release version 1.1.0-cdh5.12.1');
