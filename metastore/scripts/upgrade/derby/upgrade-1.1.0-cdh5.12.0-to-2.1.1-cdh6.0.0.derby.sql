...
UPDATE "APP".VERSION SET SCHEMA_VERSION='2.1.1', VERSION_COMMENT='Hive release version 2.1.1' where VER_ID=1;
UPDATE "APP".CDH_VERSION SET SCHEMA_VERSION='2.1.1-cdh6.0.0', VERSION_COMMENT='Hive release version 2.1.1 for CDH 6.0.0' where VER_ID=1;
