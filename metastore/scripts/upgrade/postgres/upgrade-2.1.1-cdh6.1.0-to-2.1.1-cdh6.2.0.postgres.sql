SELECT 'Upgrading MetaStore schema from 2.1.1-cdh6.1.0 to 2.1.1-cdh6.2.0';
...
SELECT 'Finished upgrading MetaStore schema from 2.1.1-cdh6.1.0 to 2.1.1-cdh6.2.0';