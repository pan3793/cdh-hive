...
@org.apache.hadoop.hive.common.classification.InterfaceAudience.Public @org.apache.hadoop.hive.common.classification.InterfaceStability.Stable public class GetPartitionsFilterSpec implements org.apache.thrift.TBase<GetPartitionsFilterSpec, GetPartitionsFilterSpec._Fields>, java.io.Serializable, Cloneable, Comparable<GetPartitionsFilterSpec> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.filters = new ArrayList<String>(_list650.size);
                String _elem651;
                for (int _i652 = 0; _i652 < _list650.size; ++_i652)
                {
                  _elem651 = iprot.readString();
                  struct.filters.add(_elem651);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.filters != null) {
        if (struct.isSetFilters()) {
          oprot.writeFieldBegin(FILTERS_FIELD_DESC);
          {
            ...
            for (String _iter653 : struct.filters)
            {
      ...
      if (struct.isSetFilters()) {
        {
          ...
          for (String _iter654 : struct.filters)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.filters = new ArrayList<String>(_list655.size);
          String _elem656;
          for (int _i657 = 0; _i657 < _list655.size; ++_i657)
          {
            _elem656 = iprot.readString();
            struct.filters.add(_elem656);
          }
        }
        struct.setFiltersIsSet(true);
      }
