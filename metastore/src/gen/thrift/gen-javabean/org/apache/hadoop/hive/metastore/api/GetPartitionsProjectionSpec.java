            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.fieldList = new ArrayList<String>(_list642.size);
                String _elem643;
                for (int _i644 = 0; _i644 < _list642.size; ++_i644)
                {
                  _elem643 = iprot.readString();
                  struct.fieldList.add(_elem643);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetPartitionsProjectionSpec struct) throws org.apache.thrift.TException {
      ...
      if (struct.fieldList != null) {
        oprot.writeFieldBegin(FIELD_LIST_FIELD_DESC);
        {
          ...
          for (String _iter645 : struct.fieldList)
          {
      ...
      if (struct.isSetFieldList()) {
        {
          ...
          for (String _iter646 : struct.fieldList)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.fieldList = new ArrayList<String>(_list647.size);
          String _elem648;
          for (int _i649 = 0; _i649 < _list647.size; ++_i649)
          {
            _elem648 = iprot.readString();
            struct.fieldList.add(_elem648);
          }
        }
        struct.setFieldListIsSet(true);
      }
