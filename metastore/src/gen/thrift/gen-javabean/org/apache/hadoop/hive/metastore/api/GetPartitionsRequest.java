...
@org.apache.hadoop.hive.common.classification.InterfaceAudience.Public @org.apache.hadoop.hive.common.classification.InterfaceStability.Stable public class GetPartitionsRequest implements org.apache.thrift.TBase<GetPartitionsRequest, GetPartitionsRequest._Fields>, java.io.Serializable, Cloneable, Comparable<GetPartitionsRequest> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.groupNames = new ArrayList<String>(_list666.size);
                String _elem667;
                for (int _i668 = 0; _i668 < _list666.size; ++_i668)
                {
                  _elem667 = iprot.readString();
                  struct.groupNames.add(_elem667);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.groupNames != null) {
        if (struct.isSetGroupNames()) {
          oprot.writeFieldBegin(GROUP_NAMES_FIELD_DESC);
          {
            ...
            for (String _iter669 : struct.groupNames)
            {
      ...
      if (struct.isSetGroupNames()) {
        {
          ...
          for (String _iter670 : struct.groupNames)
          {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.groupNames = new ArrayList<String>(_list671.size);
          String _elem672;
          for (int _i673 = 0; _i673 < _list671.size; ++_i673)
          {
            _elem672 = iprot.readString();
            struct.groupNames.add(_elem672);
          }
        }
        struct.setGroupNamesIsSet(true);
      }
