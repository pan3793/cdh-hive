            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partitionSpec = new ArrayList<PartitionSpec>(_list658.size);
                PartitionSpec _elem659;
                for (int _i660 = 0; _i660 < _list658.size; ++_i660)
                {
                  _elem659 = new PartitionSpec();
                  _elem659.read(iprot);
                  struct.partitionSpec.add(_elem659);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetPartitionsResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.partitionSpec != null) {
        oprot.writeFieldBegin(PARTITION_SPEC_FIELD_DESC);
        {
          ...
          for (PartitionSpec _iter661 : struct.partitionSpec)
          {
      ...
      if (struct.isSetPartitionSpec()) {
        {
          ...
          for (PartitionSpec _iter662 : struct.partitionSpec)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.partitionSpec = new ArrayList<PartitionSpec>(_list663.size);
          PartitionSpec _elem664;
          for (int _i665 = 0; _i665 < _list663.size; ++_i665)
          {
            _elem664 = new PartitionSpec();
            _elem664.read(iprot);
            struct.partitionSpec.add(_elem664);
          }
        }
        struct.setPartitionSpecIsSet(true);
      }
