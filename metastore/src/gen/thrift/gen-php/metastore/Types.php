  ...
  public function write($output) {
    ...
    if ($this->fieldList !== null) {
      ...
      $xfer += $output->writeFieldBegin('fieldList', TType::LST, 1);
      {
        ...
        {
          foreach ($this->fieldList as $iter575)
          {
  ...
  public function write($output) {
    ...
    if ($this->filters !== null) {
      ...
      $xfer += $output->writeFieldBegin('filters', TType::LST, 8);
      {
        ...
        {
          foreach ($this->filters as $iter582)
          {
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::LST) {
            ...
            {
              $elem588 = null;
              $elem588 = new \metastore\PartitionSpec();
              $xfer += $elem588->read($input);
              $this->partitionSpec []= $elem588;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->partitionSpec !== null) {
      ...
      $xfer += $output->writeFieldBegin('partitionSpec', TType::LST, 1);
      {
        ...
        {
          foreach ($this->partitionSpec as $iter589)
          {
  ...
  public function write($output) {
    ...
    if ($this->groupNames !== null) {
      ...
      $xfer += $output->writeFieldBegin('groupNames', TType::LST, 6);
      {
        ...
        {
          foreach ($this->groupNames as $iter596)
          {
