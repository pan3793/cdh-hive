...
import static org.apache.hive.common.util.HiveStringUtils.stringifyException;
...
public class MetaStoreUtils {
  ...
  public static String makePartNameMatcher(Table table, List<String> partVals, String defaultStr) throws MetaException {
    ...
    // add ".*" to the regex to match anything else after the partial spec.
    if (partVals.size() < numPartKeys) {
   ...
   */
  private static PartitionSpec getSharedSDPartSpec(Table table, StorageDescriptorKey sdKey,
