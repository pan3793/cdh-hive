...
public class FilterUtils {
   ...
   */
  public static Database filterDbIfEnabled(boolean isFilterEnabled, MetaStoreFilterHook filterHook,
   ...
   * @throws MetaException
   */
  public static List<String> filterDbNamesIfEnabled(boolean isFilterEnabled,
      MetaStoreFilterHook filterHook, List<String> dbNames) throws MetaException {
    if (isFilterEnabled) {
   ...
   * @throws MetaException
   */
  public static List<String> filterTableNamesIfEnabled(boolean isFilterEnabled,
      MetaStoreFilterHook filterHook, String dbName, List<String> tableNames)
      throws MetaException{
    if (isFilterEnabled) {
   ...
   * @throws MetaException
   */
  public static List<Table> filterTablesIfEnabled(boolean isFilterEnabled,
      MetaStoreFilterHook filterHook, List<Table> tables) throws MetaException{
    if (isFilterEnabled) {
   ...
   * @throws NoSuchObjectException
   */
  public static Table filterTableIfEnabled(boolean isFilterEnabled, MetaStoreFilterHook filterHook,
      Table table) throws MetaException, NoSuchObjectException {
    if (isFilterEnabled) {
   ...
   * @throws NoSuchObjectException
   */
  public static List<TableMeta> filterTableMetasIfEnabled(boolean isFilterEnabled,
      MetaStoreFilterHook filterHook, String dbName, List<TableMeta> tableMetas)
    ...
    if (isFilterEnabled) {
      List<String> tableNames =
          tableMetas.stream().map(t -> t.getTableName()).collect(Collectors.toList());
      HashSet<String> filteredTableNames = new HashSet<>(
          filterHook.filterTableNames(dbName, tableNames));
      List<TableMeta> filtedTableMetas = new ArrayList<>(tableMetas.size());
      for (TableMeta tableMeta : tableMetas) {
        if (filteredTableNames.contains(tableMeta.getTableName())) {
   ...
   * @throws NoSuchObjectException
   */
  public static Partition filterPartitionIfEnabled(boolean isFilterEnabled,
    ...
    if (isFilterEnabled) {
      ...
      if (filteredPartition == null) {
        throw new NoSuchObjectException("Partition in " + p.getDbName() + "." +
   ...
   * @throws MetaException
   */
  public static List<Partition> filterPartitionsIfEnabled(boolean isFilterEnabled,
   ...
   * @throws MetaException
   */
  public static List<String> filterPartitionNamesIfEnabled(boolean isFilterEnabled,
      MetaStoreFilterHook filterHook, final String dbName,
      final String tableName, List<String> partitionNames) throws MetaException {
    if (isFilterEnabled) {
      return
          filterHook.filterPartitionNames(dbName, tableName, partitionNames);
    }
   ...
   * @throws MetaException
   */
  public static List<PartitionSpec> filterPartitionSpecsIfEnabled(boolean isFilterEnabled,
      MetaStoreFilterHook filterHook, List<PartitionSpec> partitionSpecs) throws MetaException {
    if (isFilterEnabled) {
      return
  ...
  public static Index filterIndexIfEnabled(boolean isFilterEnabled,
      MetaStoreFilterHook filterHook, Index index)  throws MetaException, NoSuchObjectException {
    if (isFilterEnabled) {
      return
          filterHook.filterIndex(index);
    }
    return index;
  }

  public static  List<String> filterIndexNamesIfEnabled(boolean isFilterEnabled,
      MetaStoreFilterHook filterHook, final String dbName,
      final String tableName, List<String> indexNames) throws MetaException {
    if (isFilterEnabled) {
      return
          filterHook.filterIndexNames(dbName, tableName, indexNames);
    }
    return indexNames;
  }

  public static List<Index> filterIndexesIfEnabled(boolean isFilterEnabled,
      MetaStoreFilterHook filterHook, List<Index> indexes) throws MetaException {
    if (isFilterEnabled) {
      return
          filterHook.filterIndexes(indexes);
    }
    return indexes;
  }
  ...
  public static void checkDbAndTableFilters(boolean isFilterEnabled,
      MetaStoreFilterHook filterHook, final String dbName,
      final String tblName) throws NoSuchObjectException, MetaException {
    if (dbName == null) {
    ...
    List<String> filteredTable = filterTableNamesIfEnabled(isFilterEnabled, filterHook, dbName,
            Collections.singletonList(tblName));
