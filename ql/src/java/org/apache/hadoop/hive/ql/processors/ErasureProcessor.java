...
public class ErasureProcessor implements CommandProcessor {
  ...
  /**
   * No-op. Shall be removed after HIVE-17913 is backported.
   */
  @Override
  public void init() {
  }
  ...
  /*
   HIVE-18238: makes CommandProcessor to extend from AutoCloseable
   Will have to uncomment if it's backported
  @Override
