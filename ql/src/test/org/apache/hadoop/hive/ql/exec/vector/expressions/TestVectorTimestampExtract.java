...
public class TestVectorTimestampExtract {
  ...
  private boolean doVectorCastTest(TypeInfo dateTimeStringTypeInfo,
      ...
      TypeInfo[] typeInfos, List<ExprNodeDesc> children,
      ExprNodeGenericFuncDesc exprDesc,
    ...
    resultVectorExtractRow.init(new TypeInfo[] { TypeInfoFactory.intTypeInfo },
        new int[] { vectorExpression.getOutputColumn() });
    ...
    while (true) {
      ...
      extractResultObjects(batch, rowIndex, resultVectorExtractRow, scrqtchRow,
          TypeInfoFactory.intTypeInfo, resultObjects, vectorExpression.getOutputColumn());
      rowIndex += batch.size;
    }
