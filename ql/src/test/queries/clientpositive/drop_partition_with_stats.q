...
ALTER TABLE testtable DROP PARTITION (part1='p11', Part2='P12');
ALTER TABLE TestTable1 DROP PARTITION (part1='p11', Part2='P12');
ALTER TABLE TESTTABLE2 DROP PARTITION (part1='p11', Part2='P12');
