...
select * from test_alter2 order by id;
...
select * from test_alter2 order by ts;
...
-- select * from test_alter3 order by id1;
select id1, id2, id3 from test_alter3 order by id1;
