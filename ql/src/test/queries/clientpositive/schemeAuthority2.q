...
alter table dynPart add partition (value='0', value2='clusterA') location 'file:///tmp/test_sa2';
alter table dynPart add partition (value='0', value2='clusterB') location 'hdfs:///tmp/test_sa2';
