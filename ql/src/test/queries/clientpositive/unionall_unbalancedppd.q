...
insert into table union_all_bug_test_2 select count(*) from union_all_bug_test_2;
insert into table union_all_bug_test_1 select 0,0 from union_all_bug_test_2;
insert into table union_all_bug_test_1 select 1,1 from union_all_bug_test_2;
insert into table union_all_bug_test_2 select count(*) from union_all_bug_test_2;
