...
class TStatus {
 public:
  ...
  TStatus() : sqlState(""), errorCode(0), errorMessage("") {
  }
...
class TOperationHandle {
 public:
  ...
  TOperationHandle() : hasResultSet(0), modifiedRowCount(0) {
  }
...
class TOpenSessionReq {
 public:
  ...
  TOpenSessionReq() : username(""), password("") {
