...
public class TGetTablesReq implements org.apache.thrift.TBase<TGetTablesReq, TGetTablesReq._Fields>, java.io.Serializable, Cloneable {
  ...
  private List<String> tableTypes; // required
          ...
          if (field.type == org.apache.thrift.protocol.TType.LIST) {
            {
              ...
              this.tableTypes = new ArrayList<String>(_list77.size);
              for (int _i78 = 0; _i78 < _list77.size; ++_i78)
              {
                String _elem79; // required
                _elem79 = iprot.readString();
                this.tableTypes.add(_elem79);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
    ...
    if (this.tableTypes != null) {
      if (isSetTableTypes()) {
        ...
        {
          oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRING, this.tableTypes.size()));
          for (String _iter80 : this.tableTypes)
          {
